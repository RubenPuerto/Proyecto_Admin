...
<html>
        ...
        <div class="container">
            <div class="col-xs-6 col-md-4">
                ...
                <ul class="nav nav-pills nav-stacked bs-docs-sidenav affix">
                    ...
                    <li class="active"><a href="Reportes.jsp">Reporte</a></li>
                </ul>
   ...
   <tr>
    <td colspan="2">
        <select name="txtidcliente2" id='txtidcliente2' class="form-control">
...
%> 
        ...
        <tr>
          ...
          <td><input id='BotonGenerar' class='btn btn-default' type="submit" name="button" id="button" value="Generar Reporte"></td>
        </tr>
      </table>
    </form>
