 ...
 * @author RUBEN
 */
public class ColumnEliminarItem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            {   
                ...
                out.println("<td><input type='button' id='submit2' value='Eliminar'  onclick='EliminarItem("+rs.getInt("IdCurso")+");' /></td>");
                out.println("</tr>");
            }
            out.println("</tbody>");
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ColumnEliminarItem.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
